...
class Sharovarshina(RulesOfENR):
    def _question(self) -> str:
        ...
        Если ответ Да то последний символ твоего ответа должен быть '!' если Нет то ставишь в самый конец символ '#'
        """
...
class FreeWordsOfENR(RulesOfENR):
    def _question(self) -> str:
        ...
        Если ответ Да то самый последний символ твоего ответа должен быть '!' если Нет то такой символ '#'
